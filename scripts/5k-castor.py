...
#  servermanager.LoadPlugin('pv_BBP.dll')
  ...
  servermanager.LoadPlugin('/scratch/castor/biddisco/build/plugins/bin/libpv_zoltan.so')
  servermanager.LoadPlugin('/scratch/castor/biddisco/build/plugins/bin/libpv_BBP.so')
